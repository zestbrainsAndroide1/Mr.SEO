...
import com.zb.mrseo.activity.ShopDetailsActivity


class ContentListAdapter(private val mActivity: Context
) :
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var llMain: LinearLayout = itemView.findViewById(R.id.ll_content)
