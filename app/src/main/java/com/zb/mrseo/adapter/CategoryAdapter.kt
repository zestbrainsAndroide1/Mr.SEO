...
class CategoryAdapter(private val mActivity: Context, val onCategoryClick: OnCategoryClick) :
    RecyclerView.Adapter<CategoryAdapter.MyViewHolder>() {

    private var mModel = ArrayList<CategoryListModel.Data.Category>()
    ...
    fun addAll(mData: ArrayList<CategoryListModel.Data.Category>?) {
        mModel.addAll(mData!!)
