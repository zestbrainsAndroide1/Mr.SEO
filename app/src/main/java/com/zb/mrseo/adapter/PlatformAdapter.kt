...
class PlatformAdapter(private val mActivity: Context, val onPlatformClick: OnPlatformClick) :
    RecyclerView.Adapter<PlatformAdapter.MyViewHolder>() {

    private var mModel = ArrayList<PlatformListModel.Datum>()
    ...
    override fun onBindViewHolder(
        ...
        holder.tvTitle.text = mModel[listPosition].title

        holder.llMain.setOnClickListener {

            onPlatformClick.onPlatformCllick(
                listPosition,
                mModel[listPosition].title.toString(),
    ...
    fun addAll(mData: ArrayList<PlatformListModel.Datum>?) {
        mModel.addAll(mData!!)
