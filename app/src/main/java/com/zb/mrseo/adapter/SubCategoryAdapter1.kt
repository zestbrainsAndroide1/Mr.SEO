...
class SubCategoryAdapter1(private val mActivity: Context,
                          private val mModel: ArrayList<CategoryListModel.Data.Category.SubCategory>,
                          val onCategoryClick: OnCategoryClick) :
    RecyclerView.Adapter<SubCategoryAdapter1.MyViewHolder>() {
...
*/
    ...
    override fun onBindViewHolder(
        ...
        holder.llMain.setOnClickListener {
            ...
            onCategoryClick.onSubCategoryClick1(
                listPosition,
